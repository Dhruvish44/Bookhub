...
//         try {
//           setLoading(true);
//           // Send the registration request without email verification
//           const { data } = await axios.post('/api/v1/users/signup-without-verification', value);
//           setLoading(false);
//           toast.success(data.message);
//           action.resetForm();
//         } catch (error) {
...
//             <h1>Join Our Book Enthusiasts Community</h1>
//             <p>
//               Discover the latest literary trends, elevate your reading game, and
//               expand your book collection. Sign up today and become a part of our
//               vibrant community of book enthusiasts. Immerse yourself in the world of
//               literature!
//             </p>
//           </div>
//           <div className="col-2">
...
//                   <p className="error-fields">{errors.firstName}</p>
//                 ) : null}
//                 <input
//                   type="name"
//                   name="lastName"
...
//                   <p className="error-fields">{errors.lastName}</p>
//                 ) : null}
...
//                   <p className="error-fields">{errors.confirmPassword}</p>
//                 ) : null}

//                 <p>
//                   By creating an account, I consent to the processing <br /> of my
//                   personal data in accordance with the <br /> PRIVACY POLICY
//                 </p>
//                 <button className="btn" type="submit">
//                   {loading ? (
//                     <Hourglass
