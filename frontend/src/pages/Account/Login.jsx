      ...
      <div className="container">
        <div className="row">
          <div className="col-2">
            <h1>Welcome Back!</h1>
            <p>
              Step into a world of literary style and convenience. Log in to your
              account to access your favorite books, exclusive offers, and a
              seamless shopping experience. Your literary journey awaits!
            </p>
          </div>
          <div className="col-2">
            <div className="form-page">
